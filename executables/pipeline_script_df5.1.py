...
##################################################
### df5 singificant values that dont need a cut### 
##################################################

# drop length because they are not significant. Pearsons p_value > 0.05
...
df_cut = df_cut[['genetic','exercise','smoking','alcohol','bmi','length','sugar']]
...
# save to SQLlite
df5.to_sql('df5_1', if_exists='replace', con=dbConnection)
print('Generated DF5_1: succesfully written to SQL database')
df5.to_csv('df5_1.csv')
print('Generated DF5_1: succesfully written to df5_1.csv')
